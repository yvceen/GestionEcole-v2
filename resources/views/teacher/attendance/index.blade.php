<x-teacher-layout
    ...
    subtitle="Saisissez les présences, absences et retards par classe et par date, puis retrouvez vos derniers appels en un coup d'oeil."
>
    @include('partials.attendance.manual-register', [
        ...
        'pageSubtitle' => "Saisissez les présences, absences et retards par classe et par date, puis retrouvez vos derniers appels en un coup d'oeil.",
        'modeBadge' => 'Saisie manuelle enseignant',
        'helperCopy' => "Si un appel existe déjà pour cette classe et cette date, la saisie est rechargee et sera mise a jour sans creer de doublons.",
