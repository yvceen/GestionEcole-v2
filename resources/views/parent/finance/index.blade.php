<x-parent-layout title="Finance" subtitle="Suivez l historique des paiements de vos enfants, consultez les reçus et gardez une vue claire sur votre dossier.">
    ...
    <section class="mt-6 grid gap-4 md:grid-cols-5">
        <article class="student-kpi">
            ...
            <p class="student-kpi-copy">Montant cumule sur votre sélection.</p>
        </article>
        <article class="student-kpi">
        ...
        <article class="student-kpi">
            <p class="student-kpi-label">Mois impayés</p>
    ...
    <section class="student-panel mt-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <p class="student-panel-title">Mois impayés et retards</p>
                <p class="student-panel-copy">Calcul basé sur le plan de frais mensuel de chaque enfant et les mois déjà réglés.</p>
            </div>
        ...
        <div class="mt-5 grid gap-4 lg:grid-cols-2">
            ...
            @empty
                <div class="student-empty lg:col-span-2">Aucun enfant sélectionné pour le calcul financier.</div>
            @endforelse
        </div>
    </section>
    ...
    <section class="mt-6 space-y-4">
            ...
            <article class="student-panel">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('parent.finance.receipts.show', $receipt) }}" data-loading-label="Ouverture du reçu..." class="app-button-secondary rounded-full px-4 py-2 text-sm font-semibold">
                            Voir le reçu
                        </a>
        ...
        @empty
            <div class="student-empty">Aucun paiement enregistré pour votre sélection.</div>
        @endforelse
    </section>
