...
@php
    ...
    $nav = [
        ...
        ['label' => 'Santé et urgences', 'route' => 'director.health.index', 'icon' => 'shield', 'active_routes' => ['director.health.*'], 'section' => 'Suivi'],
        ['label' => 'Autorisations numériques', 'route' => 'director.digital-authorizations.index', 'icon' => 'clipboard', 'active_routes' => ['director.digital-authorizations.*'], 'section' => 'Suivi'],
        ['label' => 'Demandes de documents', 'route' => 'director.document-requests.index', 'icon' => 'book', 'active_routes' => ['director.document-requests.*'], 'section' => 'Suivi'],
        ['label' => 'Réclamations', 'route' => 'director.feedback-cases.index', 'icon' => 'message', 'active_routes' => ['director.feedback-cases.*'], 'section' => 'Suivi'],
