...
@php
    ...
    $nav = [
        ...
        ['label' => 'Demandes de documents', 'route' => 'admin.document-requests.index', 'icon' => 'book', 'active_routes' => ['admin.document-requests.*'], 'section' => 'Suivi'],
        ['label' => 'Réclamations', 'route' => 'admin.feedback-cases.index', 'icon' => 'message', 'active_routes' => ['admin.feedback-cases.*'], 'section' => 'Suivi'],
