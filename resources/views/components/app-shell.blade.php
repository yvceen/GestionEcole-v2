...
@php
    ...
    if ($user) {
        $roleLinks = match ($user->role) {
            ...
            'accueil' => [
                ['label' => 'Tableau de bord', 'route' => 'accueil.dashboard'],
                ['label' => 'Visiteurs', 'route' => 'accueil.visitors.index'],
                ['label' => 'Documents', 'route' => 'accueil.document-requests.index'],
                ['label' => 'Réclamations', 'route' => 'accueil.feedback-cases.index'],
                ['label' => 'Notifications', 'route' => 'accueil.notifications.index'],
            ],
            'super_admin' => [
    ...
    $sidebarIcons = [
        ...
        'calendar-check' => '<rect x="4" y="5" width="16" height="15" rx="2" /><path stroke-linecap="round" stroke-linejoin="round" d="M8 3v4M16 3v4M4 10h16" /><path stroke-linecap="round" stroke-linejoin="round" d="m8 15 2 2 5-5" />',
        'chart' => '<path stroke-linecap="round" stroke-linejoin="round" d="M5 19V9m7 10V5m7 14v-7" />',
        'file' => '<path stroke-linecap="round" stroke-linejoin="round" d="M7 3h6l4 4v14H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M13 3v5h5M8 13h8M8 17h5" />',
        'heart' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 20s-7-4.4-7-10a4 4 0 0 1 7-2.6A4 4 0 0 1 19 10c0 5.6-7 10-7 10Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M9 13h2l1-2 1.5 4 1-2H17" />',
        'bus' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6 4h12a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M4 10h16M7 17v2m10-2v2M8 14h.01M16 14h.01M8 7h8" />',
        'spark' => '<path stroke-linecap="round" stroke-linejoin="round" d="M13 3 9.8 9.8 3 13l6.8 3.2L13 23l3.2-6.8L23 13l-6.8-3.2L13 3Z" />',
        'hand' => '<path stroke-linecap="round" stroke-linejoin="round" d="M7 12V7.5a1.5 1.5 0 0 1 3 0V12" /><path stroke-linecap="round" stroke-linejoin="round" d="M10 11V6a1.5 1.5 0 0 1 3 0v5" /><path stroke-linecap="round" stroke-linejoin="round" d="M13 11V7a1.5 1.5 0 0 1 3 0v6" /><path stroke-linecap="round" stroke-linejoin="round" d="M16 13v-1a1.5 1.5 0 0 1 3 0v2.5A6.5 6.5 0 0 1 12.5 21H11a6 6 0 0 1-4.2-1.8L4 16.4a1.6 1.6 0 0 1 2.2-2.3L8 15.5V12" />',
        'card' => '<rect x="3" y="5" width="18" height="14" rx="2.5" /><path stroke-linecap="round" stroke-linejoin="round" d="M3 9h18M7 14h4M15 14h2" />',
