<x-school-life-layout title="Saisie manuelle des presences" subtitle="Conservez le scan QR et ajoutez une saisie manuelle rapide pour corriger ou enregistrer un appel.">
    @include('partials.attendance.manual-register', [
        ...
        'pageSubtitle' => "Saisissez ou corrigez les presences depuis la vie scolaire, tout en conservant le scan des cartes.",
