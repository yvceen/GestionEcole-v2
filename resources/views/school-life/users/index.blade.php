<x-school-life-layout title="Utilisateurs" subtitle="Gestion des comptes eleves, parents, enseignants, chauffeurs et responsables scolaires.">
    ...
    <section class="overflow-hidden rounded-[32px] border border-slate-200 bg-[radial-gradient(circle_at_top_right,_rgba(14,165,233,0.22),_transparent_32%),linear-gradient(135deg,#0f172a,#1e1b4b_52%,#0f766e)] px-6 py-6 text-white shadow-xl shadow-slate-200/70 md:px-8">
