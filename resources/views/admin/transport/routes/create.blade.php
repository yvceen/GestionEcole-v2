    ...
    <x-ui.card title="Circuit de transport" subtitle="Définissez l'itinéraire, le véhicule et la liste des arrêts.">
        <form method="POST" action="{{ route('admin.transport.routes.store') }}" class="space-y-5">
            ...
            <div class="app-field">
                ...
                <input type="text" name="route_name" value="{{ old('route_name') }}" class="app-input @error('route_name') border-rose-500 @enderror" placeholder="Route Rabat - Casablanca" required>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="app-field">
                    ...
                    <input type="number" name="distance_km" value="{{ old('distance_km') }}" step="0.1" min="0" class="app-input @error('distance_km') border-rose-500 @enderror" placeholder="15.5">
