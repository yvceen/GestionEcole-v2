<x-admin-layout title="Modifier l'affectation">
    ...
    <x-ui.card title="Affectation transport" subtitle="Ajustez la route, la période et l'etat de l'affectation.">
        <form method="POST" action="{{ route('admin.transport.assignments.update', $transportAssignment) }}" class="space-y-5">
            ...
            <x-ui.alert variant="info">
                Vous pouvez définir une date de fin pour cloturer cette affectation.
            </x-ui.alert>
