<x-admin-layout title="Agenda hebdomadaire" subtitle="Organisez les cours, examens et activites avec une vue claire et rapide.">
    <section class="relative overflow-hidden rounded-[34px] border border-sky-100 bg-gradient-to-br from-slate-950 via-sky-900 to-cyan-700 px-6 py-7 text-white shadow-2xl shadow-sky-100 md:px-8">
        ...
        <div class="relative flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">Agenda de l etablissement</h1>
            ...
            <div class="flex flex-wrap gap-3">
                ...
                @endif
                <x-ui.button :href="route('admin.activities.index')" variant="ghost">Activites</x-ui.button>
            </div>
        </div>
    </section>
