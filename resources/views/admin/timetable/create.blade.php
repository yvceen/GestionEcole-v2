...
<x-dynamic-component :component="$layoutComponent" title="Nouvel emploi du temps">
    <x-ui.page-header
    ...
    <x-ui.card title="Creneau" subtitle="Renseignez la classe, le jour, les horaires et l'enseignant.">
        <form method="POST" action="{{ route($routePrefix . '.store') }}" class="space-y-6">
            ...
            <div class="flex items-center gap-3 border-t border-slate-200 pt-4">
                ...
                <x-ui.button :href="route($routePrefix . '.index', ['classroom_id' => old('classroom_id', $selectedClassroomId)])" variant="secondary">Annuler</x-ui.button>
            </div>
        </form>
    </x-ui.card>
</x-dynamic-component>
